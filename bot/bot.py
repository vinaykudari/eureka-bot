...
class EurekaBot(Controller):
    ...
    def _rotate(self, angle=0, duration=0, speed=0, direction='clockwise'):
        ...
        self._turn(duration=duration, speed=speed)
        self._break()
    ...
    def move_forward(self, acceleration=0, duration=3):
        ...
        self._move(duration=duration, acceleration=acceleration)
        self.stop()
    ...
    def move_left(self, speed=0, angle=90):
        self._rotate(angle=angle, speed=speed, direction='anti-clockwise')

    def move_right(self, speed=0, angle=90):
        self._rotate(angle=angle, speed=speed, direction='clockwise')
